  ...
  <div>
    ...
    <div>
      <a-table
          ...
          rowKey="id"
      >
        <span slot="kinds" slot-scope="kind">
          <a-tag :key="kind">
            {{ convertKind(kind) }}
          </a-tag>
        </span>
...
export default {
  ...
  methods: {
    ...
    onDelete(key) {
      console.log(key);
      axios_service.delete_with_params(this.$store, "/origins/" + key, null).then((res) => {
        console.log(res);
        let _this = this;
        _this.loading = true;
        _this.queryTable();
    ...
    updateCreate() {
      ...
      form.validateFields((err, values) => {
        ...
        axios_service.put_with_params(this.$store, "/origins/" + this.updateRecorder.id, params).then((res) => {
          console.log(res);
          let _this = this;
          _this.loading = true;
          _this.queryTable();
    ...
    handleCreate() {
      ...
      form.validateFields((err, values) => {
        ...
        axios_service.post_with_params(this.$store, "/origins", params).then((res) => {
          console.log(res);
          let _this = this;
          _this.loading = true;
          _this.queryTable();
    ...
    queryTable() {
      let _this = this;
      _this.loading = true;
      axios_service.get_with_params(this.$store, "/origins", null).then((res) => {
        //将返回的数据存入页面中声明的data中
        _this.data = res;
        _this.loading = false;
      })
