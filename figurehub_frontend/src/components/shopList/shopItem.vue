    ...
    <div class="item-content">
      ...
      <div class="word-container">
        <div class="left-word-container">
          <h1 class="h1title">{{ this.picturesMessage.picture.title }}</h1>
          <div style="width: fit-content; margin-bottom: 10px">
            ...
            >
              ...
              <div class="name">{{ this.picturesMessage.picture.owner }}</div>
            </div>
          </div>
        </div>
        <div class="right-word-container">
          <span style="font-size:20px; color: #00a0d8; "><b>￥</b></span>
          <span class="wordOfPrice">{{ showPrice(this.picturesMessage.picture.price) }}</span>
        </div>
      </div>
    </div>
  </div>
