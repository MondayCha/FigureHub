    ...
    doSubmit() {
      ...
      this.$refs.registerForm.validate(valid => {
        if (valid && this.checkFile(_this.file)) {
          ...
          formData.append('name', _this.registerForm.username);
          formData.append('password', _this.registerForm.pass);
          formData.append('nickname', _this.registerForm.nickname);
          formData.append('kind', _this.registerForm.type);
          formData.append('avatar', _this.file);
          axios_service.register(_this.store, "/user/register", formData)
              .then((res) => {
