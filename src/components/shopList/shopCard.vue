<template>
  ...
  >
    <div class="cover-container">
      <dpi-img class="cover" :src="this.data.coverUrl" :size="{height: 120, width: 315}"></dpi-img>
...
export default {
  ...
  // store,
  components: {
    'dpi-img': () => import('../../views/dpi-img'),
    Icon: () => import('../../views/icon.vue')
  },
  data() {
    return {
      upFaceUrl: 'http://localhost:2333/ImgStore/logo.svg',
      danmakuCount: '',
      like: '',
      coins: '',
      favorites: '',
